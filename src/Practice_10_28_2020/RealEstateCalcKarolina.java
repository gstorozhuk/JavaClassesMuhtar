...
public class RealEstateCalcKarolina {
    ...
    public static void main(String[] args) {
        ...
        if (houseType.equalsIgnoreCase("Condo") || houseType.equalsIgnoreCase("Townhouse")
                || houseType.equalsIgnoreCase("Single Family Home")) {

            propertyPrice = (houseType.equalsIgnoreCase("Condo")) ? 50000 :
                    (houseType.equalsIgnoreCase("Townhouse")) ? 75000 : 95000;
